...
export const helpBox: React.CSSProperties = { padding: "8px 12px", backgroundColor: T.bg3, border: `1px solid ${T.border}`, borderRadius: "3px" };
export const helpSub: React.CSSProperties = { color: "#e9a045", fontSize: "11px", fontWeight: "bold", marginTop: "6px", marginBottom: "2px" };
...
export function HelpButton({ show, onToggle }: { show: boolean; onToggle: () => void }) {
  return (
    <button onClick={onToggle} style={{
      ...
      borderRadius: "3px", cursor: "pointer", fontSize: "11px", color: show ? T.danger : T.textSub,
    }}>[?]</button>
  );
}
